...
const setTrustline = async (client,hot,tokenTickerHex, issuerAddress,amount,tokenTicker,unreliable)=>
{   
    ...
    return new Promise(async (resolve,reject)=>{
        try{
            ...
            if(unreliable){await prepareSignSend(client,tx,hot,unreliable)}
            else{await prepareSignSend(client,tx,hot)}
            stopSpinner(spinner)
