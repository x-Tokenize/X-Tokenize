        ...
        try{
            ...
            switch(tool.toolType)
            {
                ...
                case 'View Funded Wallets':
                    ...
                    let returnHome = await inquirer.pressEnterToReturn();
                    resolve();
                    break;
                case 'Set TrustLines To An Existing Project':
                    ...
                    for(let i=0;i<fundedWs.length;i++)
                    {
                       ...
                       await setTrustline(client,w,tokenTickerHex,issuerAddress,amount,tokenTicker) 
                    }
                    let returnHome2 = await inquirer.pressEnterToReturn();
                    resolve();
                    break;
